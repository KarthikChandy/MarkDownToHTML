...
3. Open the **Terminal** and browse to the directory.
...
5. Next run the following command in the same directory, to install the required dependency. This step should create a `package-lock.json` file.
